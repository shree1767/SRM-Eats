    ...
    <>
      <div className="flex mx-5">
        <div className="py-12 md:my-12 my-5 lg:px-5 px-3 md:mx-3 mx-auto min-w-[45vw] md:text-left text-center">
          <div className="text-[#ffffff] md:text-[40px] text-[35px] font-bold mt-12 pt-5">
            Meals on Tips?
          </div>
          <div className="text-[#ffffff] md:text-[25px] text-[18px] font-regular ">
            Order food from Java to your hostel
          </div>
