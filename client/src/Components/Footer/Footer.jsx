...
<footer className="p-4 bg-[#242424] sm:p-6">
    <div className="md:flex py-[50px] md:justify-between">
        <div className="mb-6 md:mb-0 mx-[100px]">
            <Link to="/" className="flex items-center">
                <img src={logo} alt="SrmEats Logo" />
            </Link>
        </div>
        <div className="grid grid-cols-2 gap-5 sm:gap-6 md:pr-20 sm:grid-cols-3">
            <div>
    ...
    <div className="md:flex sm:items-center sm:justify-between">
        ...
        <span className="text-sm text-white sm:text-center">© 2023 <Link to="/">SRM Eats™</Link>. All Rights Reserved.
        </span>
        <div className="text-sm text-white sm:text-center ">Created with love 🖤
        </div>
    </div>
</footer>
